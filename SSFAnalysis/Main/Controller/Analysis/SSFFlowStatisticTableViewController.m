...
- (void)configureHeadView {
    ...
    self.incomeLabel.text = [NSString stringWithFormat:@"%f",[[SSFAnalysisManager sharedManager] incomeOfThisYearWithUser]];
    self.costLabel.text = [NSString stringWithFormat:@"%f",[[SSFAnalysisManager sharedManager] costOfThisYearWithUser]];
    self.surplusLabel.text = [NSString stringWithFormat:@"%f",[[SSFAnalysisManager sharedManager] surplesOfThisYearWithUser]];
}
